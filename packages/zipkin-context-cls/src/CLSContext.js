...
var createNamespace = _require.createNamespace;
var getNamespace = _require.getNamespace;


module.exports = function () {
  function CLSContext() {
    var namespace = arguments.length <= 0 || arguments[0] === undefined ? 'zipkin' : arguments[0];
