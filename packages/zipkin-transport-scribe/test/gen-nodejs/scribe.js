...
scribe_Log_args = function scribe_Log_args(args) {
  this.messages = null;
  if (args) {
...
scribe_Log_result = function scribe_Log_result(args) {
  this.success = null;
  if (args) {
...
scribeClient.prototype.seqid = function () {
  return this._seqid;
};
scribeClient.prototype.new_seqid = function () {
...
scribeProcessor.prototype.process_Log = function (seqid, input, output) {
  ...
  if (this._handler.Log.length === 1) {
    Q.fcall(this._handler.Log, args.messages).then(function (result) {
